...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta name="twitter:title" content="Bill's Heating & A/C | Financing">
    <meta name="twitter:description" content="Explore flexible financing options at Bill's Heating & A/C for HVAC solutions. Variety of plans through Greensky and Synchrony. Clear terms, easy application.">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NZQJPVRS"
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <section class="financing-header-outer">
    ...
    <section class="four-card-outer">
        ...
        <div class="four-card-inner width-limiter">
            <div class="tune-cards">
                ...
                <p>From immediate payment plans to long&dash;term financing, we have a solution for you.</p>
            </div>
            <div class="tune-cards">
                <h2>Clarity and Transparency</h2>
                <p>Clear terms, no hidden fees. What you see is what you get.</p>
            </div>
            <div class="tune-cards">
                <h2>Ease of Application</h2>
                <p>Simple process, quick decisions, less hassle.</p>
            </div>
            <div class="tune-cards">
                <h2>Peace of Mind</h2>
                <p>Work with trusted financial providers to secure your investment.</p>
            </div>
    ...
    <section class="get-started-outer">
        <div class="get-started width-limiter">
            ...
            <div class="lets-get-started" data-animation="zoom-in-right">
                ...
                <p>Ready to make your home comfortable without financial strain? Contact Bill&apos;s Heating &amp; A/C office for more details and to apply for the best financing option for you.</p>
            </div>
        </div>
    </section>
