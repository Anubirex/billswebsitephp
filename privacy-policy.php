...
<html lang="en">
  ...
  <body>
    ...
    <div class="privacy-policy-container width-limiter">
      ...
      <p>
        Bill&apos;s Heating & A/C respects your privacy as our website visitors, and we commit to keep your personal information completely secure. We developed this privacy policy to describe how we collect and process your personal data.</p>
          <h2>INFORMATION WE COLLECT</h2>
          <p>Bill&apos;s Heating & A/C collects personal data, including names, gender, enterprise name, postal and email address, phone number, login details, and more. We also collect other information you provide to us as well as the contents of the messages you sent or the information you provided for our customer service support.
          <br><br>
          ...
          <h2>  WHAT DO WE USE YOUR INFORMATION FOR</h2>
           <p> We may use your personal data for the following purposes&colon;<p>
            <ul>
              <li>Contact you with consent and send updates and notices about our products and services that may interest you</li>
              <li>Fulfill your service requests and transactions as well as provide technical support</li>
              <li>Provide you with better and customized user-experience</li>
              <li>Improve our products and services through research and data analysis</li>
              <li>Perform and improve our anti-fraud and loss prevention programs</li>
              <li>Comply with applicable legal requirements and industry standards</li>
            </ul>
            <h2>INFORMATION SECURITY</h2>
<p>Your personal information&apos;s security is important to us. We use technical measures to safeguard your data from unauthorized access, loss, damage, or disclosure. We use cryptographic technology to keep your data confidential and only allow authorized access to it.
</p>
<h2>COOKIES</h2>
<p>Bill&apos;s Heating & A/C uses a small piece of data called &quot;cookies&quot; on your device. A cookie is a text file that consists of website names, identifiers, and characters and numbers stored by the server on your device. It is used to improve user experience.
</p>
<h2>UPDATES</h2>
<p>Our privacy policy statement and practices may be updated anytime to comply with regulatory requirements and changes in applicable laws, adapt to new protocols, and align with the industry&apos;s best practices and business purposes.
  <br><br>
