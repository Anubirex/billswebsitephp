...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/cocolalla.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/cocolalla-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/cocolalla.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/cocolalla-summary-large-image.webp">
  ...
  <!-- End Google Tag Manager (noscript) -->
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/cocolalla-header-800w.webp"
                srcset="images/cocolalla-header-450w.webp 450w, 
                        images/cocolalla-header-800w.webp 800w, 
                        images/cocolalla-header-1800w.webp 1800w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        1800px"
                alt="Background photo of Cocolalla, Idaho"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Cocolalla, ID, a serene and picturesque community, faces a climate that underscores the necessity for effective heating and cooling systems. Winters in Cocolalla are often cold, with the potential for snow, demanding reliable heating solutions to ensure a cozy indoor atmosphere. Summers, while generally moderate, can experience warm stretches, highlighting the need for efficient air conditioning to maintain comfort during these warmer periods. This variation in weather conditions in Cocolalla not only contributes to its natural beauty but also emphasizes the importance of adaptable and efficient HVAC systems to provide comfort throughout the changing seasons.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Cocolalla, ID for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Cocolalla</h2>
                        <p>Bill's Heating & A/C is deeply committed to the Cocolalla community, offering superior HVAC services that are specifically tailored to the local climate. Our team, knowledgeable about the unique weather patterns of Cocolalla, provides customized heating and cooling solutions to meet the specific needs of the area. We maintain a consistent presence in Cocolalla, with expert technicians available to ensure timely and efficient service for your HVAC systems. Our commitment to Cocolalla goes beyond service; we focus on enhancing the comfort and well-being of every household and business we serve.</p>
                    </div>
                </div>
          </section>
                    ...
                    <div class="carousel-slide">
                      <div class="review-card">
                        <div class="review-card-top">
                          ...
                          <h3>J</h3>
                          <div class="review-name-title">
                            <span class="reviewer-name">Bonnie Hollenbeck</span>
                            <span class="review-source">Google Review</span></div></div>
                            <div class="review-card-stars">
                              <p class="star-emojies">&#x2B50;&#x2B50;&#x2B50;&#x2B50;&#x2B50;</p></div>
                        </div>
                        <div class="review-content">
                          <p>DJ did an excellent job servicing my heating system at 496 Overlake View Rd in Cocolalla. Oren did a great job at my house in Spokane Valley as well.</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-slide">
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Cocolalla, Idaho." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Cocolalla, ID that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
