    ...
    <script type="application/ld+json">
      {
        ...
        "image": "images/ah-social-share.webp",
  ...
  <!-- End Google Tag Manager (noscript) -->
        <?php include '../header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/ah-header-800w.webp"
                srcset="images/ah-header-450w.webp 450w, 
                        images/ah-header-800w.webp 800w, 
                        images/ah-header-1500w.webp 1500w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        1500px"
                alt="Background photo of Airway Heights, WA"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Airway Heights, WA, a city with a growing community and unique charm, experiences a climate that highlights the necessity for dependable heating and cooling systems. The winters in Airway Heights can be quite chilly, often requiring a robust heating system to ensure a warm and comfortable indoor atmosphere. Summers are warm and inviting, making effective air conditioning essential for maintaining a cool and pleasant indoor environment during these warmer months. This range of weather conditions not only contributes to the city’s appeal but also underscores the need for adaptable HVAC systems to provide consistent comfort throughout the year.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Airway Heights, Washington for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Airway Heights</h2>
                        <p>Bill's Heating & A/C is deeply committed to providing Airway Heights with top-tier HVAC services. Our expertise in the local climate allows us to offer customized heating and cooling solutions that perfectly meet the needs of the community. We have a significant presence in the city, with skilled technicians ready to offer prompt and efficient service. Our dedication to Airway Heights goes beyond just service provision; we are focused on enhancing the comfort and well-being of every home and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Airway Heights, Washington." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Airway Heights, WA that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
