...
<html lang="en">
  <head>
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/hayden-summary-large-image.webp">
    ...
    <body>
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/hayden-header-800w.webp"
                srcset="images/hayden-header-450w.webp 450w, 
                        images/hayden-header-800w.webp 800w, 
                        images/hayden-header-1440w.webp 1440w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        1440px"
                alt="Background photo of Hayden, Idaho"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Hayden, ID, with its serene landscapes and a community-oriented spirit, experiences a climate that demands attention to heating and cooling needs. The city is characterized by chilly winters with substantial snowfall, requiring dependable heating systems for cozy homes and workplaces. Summers in Hayden are pleasant but can bring warmth that necessitates efficient cooling solutions. The climate in Hayden, varying from snowy winters to balmy summers, not only adds to its charm but also highlights the need for reliable and adaptable HVAC systems to ensure comfort all year round.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Hayden, ID for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Hayden</h2>
                        <p>Bill's Heating & A/C is deeply entrenched in the fabric of Hayden, offering unparalleled HVAC services tailored to the city's unique climate. Our team, well-versed in the local weather patterns, provides customized solutions to meet the heating and cooling needs of residents and businesses alike. With a strong and consistent presence in Hayden, our skilled technicians are always on standby, ready to ensure that your HVAC systems are functioning flawlessly. We take pride in being a part of the Hayden community, dedicated to maintaining the comfort and well-being of each home and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Hayden, Idaho." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Hayden, ID that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
