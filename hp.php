...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbills.com/hp.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:url" content="https://callbills.com/hp.php">
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <section class="furnace-hero">
        <div class="furnace-hero-container width-limiter">
            ...
            <h1 class="furnace-hero-content-headline ac-directory-headline">Heat Pump Services</h1><h1>At Bill&apos;s Heating and AC</h1>
