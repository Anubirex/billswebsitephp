<header>
            ...
            <div class="top-bar width-limiter">
                ...
                <img class="header-logo" alt="Bills Heating Logo" src="images/header-logo-shadowed.webp" width="400" height="177">
        ...
        <nav class="width-limiter main-nav desktop-only">
            <ul class="menu-list" role="menu">
                ...
                <li class="menu-item has-submenu" role="menuitem" aria-haspopup="true" aria-expanded="false"><a href="about.php" class="icon-menu-item has-dropdown"><span class="menu-text">About Us</span><svg class="dropdown-arrow" id="dropdown-arrow-1" data-name="Dropdown Arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.62 14.18"><polyline  class="main-icon-stroke" points="1.06 1.56 11.56 12.06 22.56 1.06"/></svg></a>
