<header>
    ...
    <div class="top-bar width-limiter">
        ...
        <a href="https://callbills.com/index.php"><img class="header-logo" alt="Bills Heating Logo" src="images/header-logo-shadowed.webp" width="400" height="177"></a>
...
<nav class="width-limiter main-nav desktop-only">
    <ul class="menu-list" role="menu">
        <li class="menu-item" role="menuitem"><a href="index.php"><span class="menu-text">Home</span></a></li>
        <li class="menu-item has-submenu" role="menuitem" aria-haspopup="true" aria-expanded="false"><a href="services.php" class="icon-menu-item has-dropdown"><span class="menu-text">Services</span><svg class="dropdown-arrow" id="dropdown-arrow-2" data-name="Dropdown Arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.62 14.18"><polyline  class="main-icon-stroke" points="1.06 1.56 11.56 12.06 22.56 1.06"/></svg></a>
            <ul class="submenu" role="menu">
                <li class="submenu-item has-submenu" role="menuitem" aria-haspopup="true" aria-expanded="false">
                  <a href="furnace.php"><svg class="furnace-icon icon-common-elements" id="furnace-icon" data-name="Furnace Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 211.5 283.5" aria-hidden="true"><g>
                    ...
                    <div class="equipment-submenu-container">
                        <ul class="equipment-submenu" role="menu">
                            <li class="equipment-submenu-item" role="menuitem">
                              <a href="furnaceinstall.php"><span class="equipment-submenu-text">Furnace Install</span></a>
                            </li>
                            <li class="equipment-submenu-item" role="menuitem">
                              <a href="furnacetune.php"><span class="equipment-submenu-text">Furnace Maintenance</span></a>
                            </li>
                            <li class="equipment-submenu-item" role="menuitem">
                              <a href="furnacediag.php"><span class="equipment-submenu-text">Furnace Diagnostics</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="submenu-item has-submenu" role="menuitem">
                  <a href="ac.php"><svg class="ac-icon icon-common-elements" id="careers-icon-1" data-name="Careers Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 272.84 283.5" aria-hidden="true"><g>
                  ...
                  <div class="equipment-submenu-container">
                    <ul class="equipment-submenu" role="menu">
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="acinstall.php"><span class="equipment-submenu-text">Air Conditioning Install</span></a>
                        </li>
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="actune.php"><span class="equipment-submenu-text">Air Conditioning Maintenance</span></a>
                        </li>
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="acdiag.php"><span class="equipment-submenu-text">Air Conditioning Diagnostics</span></a>
                        </li>
                    </ul>
                </div>
                </li>
                <li class="submenu-item has-submenu" role="menuitem">
                  <a href="hp.php"><svg class="heatpump-icon icon-common-elements" id="heatpump-icon" data-name="Heat Pump Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 278.17 283.5" aria-hidden="true"><g>
                  ...
                  <div class="equipment-submenu-container">
                    <ul class="equipment-submenu" role="menu">
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="hpinstall.php"><span class="equipment-submenu-text">Heat Pump Install</span></a>
                        </li>
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="hptune.php"><span class="equipment-submenu-text">Heat Pump Maintenance</span></a>
                        </li>
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="hpdiag.php"><span class="equipment-submenu-text">Heat Pump Diagnostics</span></a>
                        </li>
                    </ul>
                </div>
                </li>
                <li class="submenu-item has-submenu" role="menuitem">
                  <a href="ductless.php"><svg class="ductless-icon icon-common-elements" id="ductless-icon" data-name="Ductless Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 211.5" aria-hidden="true"><g>
                  ...
                  <div class="equipment-submenu-container">
                    <ul class="equipment-submenu" role="menu">
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="ductlessinstall.php"><span class="equipment-submenu-text">Ductless Install</span></a>
                        </li>
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="ductlesstune.php"><span class="equipment-submenu-text">Ductless Maintenance</span></a>
                        </li>
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="ductlessdiag.php"><span class="equipment-submenu-text">Ductless Diagnostics</span></a>
                        </li>
                    </ul>
                </div>
                </li>
                <li class="submenu-item has-submenu" role="menuitem">
                  <a href="tankless.php"><svg class="tankless-icon icon-common-elements" id="Ltankless-icon" data-name="Tankless Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 46 50" aria-hidden="true"><g>
                  ...
                  <div class="equipment-submenu-container">
                    <ul class="equipment-submenu" role="menu">
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="tanklessinstall.php"><span class="equipment-submenu-text">Tankless Install</span></a>
                        </li>
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="tanklesstune.php"><span class="equipment-submenu-text">Tankless Maintenance</span></a>
                        </li>
                        <li class="equipment-submenu-item" role="menuitem">
                          <a href="tanklessdiag.php"><span class="equipment-submenu-text">Tankless Diagnostics</span></a>
                        </li>
                    </ul>
                </div>
                </li>
                <li class="submenu-item" role="menuitem">
                  <a href="generator.php"><svg class="generator-icon icon-common-elements" id="generator-icon" data-name="Generator Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.28 43.5" aria-hidden="true"><polygon class="icon-stroke" points="22.28 1 12.23 1 2.62 25 6.96 25 1 42.5 18.62 18 12.62 18 22.28 1"/></svg>
                  <span class="submenu-text">Generator</span></a>
                </li>
                <li class="submenu-item" role="menuitem">
                  <a href="evcharger.php"><svg class="charger-icon icon-common-elements" id="charger-icon" data-name="Charger Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 247.5 283.5" aria-hidden="true"><g>
                            <path class="icon-stroke" d="m6.75,24.75C6.75,14.8,14.8,6.75,24.75,6.75"/>
                ...
                <li class="submenu-item has-submenu" role="menuitem" aria-haspopup="true" aria-expanded="false">
                  <a href="areas.php" class="icon-menu-item">
                      ...
                      <div class="service-area-titles">
                        ...
                        <ul class="service-submenu" role="menu">
                          <li class="service-submenu-item" role="menuitem">
                            <a href="cda.php"><span class="service-submenu-text">Coeur D&apos;Alene</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="pf.php"><span class="service-submenu-text">Post Falls</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="hayden.php"><span class="service-submenu-text">Hayden</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="rathdrum.php"><span class="service-submenu-text">Rathdrum</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="athol.php"><span class="service-submenu-text">Athol</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="sandpoint.php"><span class="service-submenu-text">Sandpoint</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="pr.php"><span class="service-submenu-text">Priest River</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="sl.php"><span class="service-submenu-text">Spirit Lake</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="moscow.php"><span class="service-submenu-text">Moscow</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="lewiston.php"><span class="service-submenu-text">Lewiston</span></a>
                          </li>
                        </ul>
                        <ul class="service-submenu" role="menu">
                          <li class="service-submenu-item" role="menuitem">
                            <a href="hauser.php"><span class="service-submenu-text">Hauser</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="dg.php"><span class="service-submenu-text">Dalton Gardens</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="blanchard.php"><span class="service-submenu-text">Blanchard</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="bayview.php"><span class="service-submenu-text">Bayview</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="cocolalla.php"><span class="service-submenu-text">Cocolalla</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="sagle.php"><span class="service-submenu-text">Sagle</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="lapwai.php"><span class="service-submenu-text">Lapwai</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="genesee.php"><span class="service-submenu-text">Genesee</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="kendrick.php"><span class="service-submenu-text">Kendrick</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="troy.php"><span class="service-submenu-text">Troy</span></a>
                          </li>
                        </ul>
                        <ul class="service-submenu">
                          <li class="service-submenu-item" role="menuitem">
                            <a href="spokane.php"><span class="service-submenu-text">Spokane</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="sv.php"><span class="service-submenu-text">Spokane Valley</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="ll.php"><span class="service-submenu-text">Liberty Lake</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="ml.php"><span class="service-submenu-text">Medical Lake</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="ah.php"><span class="service-submenu-text">Airway Heights</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="cheney.php"><span class="service-submenu-text">Cheney</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="dp.php"><span class="service-submenu-text">Deer Park</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="newport.php"><span class="service-submenu-text">Newport</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="pullman.php"><span class="service-submenu-text">Pullman</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="clarkston.php"><span class="service-submenu-text">Clarkston</span></a>
                          </li>
                        </ul>
                        <ul class="service-submenu" role="menu">
                          <li class="service-submenu-item" role="menuitem">
                            <a href="oo.php"><span class="service-submenu-text">Otis Orchards</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="nl.php"><span class="service-submenu-text">Newman Lake</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="mead.php"><span class="service-submenu-text">Mead</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="spangle.php"><span class="service-submenu-text">Spangle</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="nmf.php"><span class="service-submenu-text">Nine Mile Falls</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="asotin.php"><span class="service-submenu-text">Asotin</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="uniontown.php"><span class="service-submenu-text">Uniontown</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="pomeroy.php"><span class="service-submenu-text">Pomeroy</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="chattaroy.php"><span class="service-submenu-text">Chattaroy</span></a>
                          </li>
                          <li class="service-submenu-item" role="menuitem">
                            <a href="colton.php"><span class="service-submenu-text">Colton</span></a>
                          </li>
                        </ul>
                    </div>
                </li>
        ...
        <li class="menu-item" role="menuitem"><a href="products.php"><span class="menu-text">Products</span></a></li>
        <li class="menu-item" role="menuitem"><a href="learninghub.php"><span class="menu-text">Learning Hub</span></a></li>
        <li class="menu-item" role="menuitem"><a href="financing.php"><span class="menu-text">Financing</span></a></li>
        <li class="menu-item" role="menuitem"><a href="savings.php"><span class="menu-text">Savings</span></a></li>
        <li class="menu-item has-submenu" role="menuitem" aria-haspopup="true" aria-expanded="false"><a href="story.php" class="icon-menu-item has-dropdown"><span class="menu-text">About Us</span><svg class="dropdown-arrow" id="dropdown-arrow-1" data-name="Dropdown Arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.62 14.18"><polyline  class="main-icon-stroke" points="1.06 1.56 11.56 12.06 22.56 1.06"/></svg></a>
            <ul class="about-us-submenu submenu" role="menu">
                <li class="submenu-item" role="menuitem">
                  <a href="story.php"><svg class="story-icon icon-common-elements" id="story-icon" data-name="Story Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 93.65 123.43" aria-hidden="true"><g>
                ...
                <li class="submenu-item" role="menuitem">
                  <a href="careers.php"><svg class="careers-icon icon-common-elements" id="careers-icon-2" data-name="Careers Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 154.63 112.05" aria-hidden="true"><g>
                    <g>
                      <g>
                        <g>
                ...
                <li class="submenu-item" role="menuitem">
                  <a href="reviews.php"><svg class="review-icon icon-common-elements" id="review-icon" data-name="Review Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129.45 113.99" aria-hidden="true">
                      <g>
                        <g>
                ...
                <li class="submenu-item" role="menuitem"><a href="news.php" class="news-container"><svg class="news-icon icon-common-elements" id="news-icon" data-name="News Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 177.72 93.08" aria-hidden="true"><g>
  ...
  <nav class="menu-content" id="menuContent" aria-label="Main navigation">
    <ul class="bm-main-menu" role="menu">
      <a href="index.php" role="menuitem"><li class="bm-main-menu-item"><span class="bm-main-menu-text">Home</span></li></a>
      <a role="menuitem"><li class="bm-main-menu-item"><span class="bm-main-menu-text">Services</span></li></a>
      <a href="areas.php" role="menuitem"><li class="bm-main-menu-item"><span class="bm-main-menu-text">Service Areas</span></li></a>
      <a href="products.php" role="menuitem"><li class="bm-main-menu-item"><span class="bm-main-menu-text">Products</span></li></a>
      <a href="learninghub.php" role="menuitem"><li class="bm-main-menu-item"><span class="bm-main-menu-text">Learning Hub</span></li></a>
      <a href="financing.php" role="menuitem"><li class="bm-main-menu-item"><span class="bm-main-menu-text">Financing</span></li></a>
      <a href="savings.php" role="menuitem"><li class="bm-main-menu-item"><span class="bm-main-menu-text">Savings</span></li></a>
    ...
    <ul class="bm-service-menu" role="menu">
      <a href="furnace.php" role="menuitem"><li class="bm-service-menu-item"><span class="bm-service-menu-text">Furnace</span></li></a>
      <a href="ac.php" role="menuitem"><li class="bm-service-menu-item"><span class="bm-service-menu-text">A/C</span></li></a>
      <a href="hp.php" role="menuitem"><li class="bm-service-menu-item"><span class="bm-service-menu-text">Heat Pump</span></li></a>
      <a href="ductless.php" role="menuitem"><li class="bm-service-menu-item"><span class="bm-service-menu-text">Ductless</span></li></a>
      <a href="tankless.php" role="menuitem"><li class="bm-service-menu-item"><span class="bm-service-menu-text">Tankless</span></li></a>
      <a href="generator.php" role="menuitem"><li class="bm-service-menu-item"><span class="bm-service-menu-text">Generator</span></li></a>
      <a href="evcharger.php" role="menuitem"><li class="bm-service-menu-item"><span class="bm-service-menu-text">EV Charger</span></li></a>
    </ul>
    <ul class="bm-about-menu" role="menu">
      <a href="story.php" role="menuitem"><li class="bm-about-menu-item"><span class="bm-about-menu-text">Our Story</span></li></a>
      <a href="careers.php" role="menuitem"><li class="bm-about-menu-item"><span class="bm-about-menu-text">Careers</span></li></a>
      <a href="reviews.php" role="menuitem"><li class="bm-about-menu-item"><span class="bm-about-menu-text">Reviews</span></li></a>
      <a href="news.php" role="menuitem"><li class="bm-about-menu-item"><span class="bm-about-menu-text">News</span></li></a>
    </ul>
  </nav> 
    <!-- ////////////////////////////// SEARCH BAR ////////////////////////////////////////////////// -->
