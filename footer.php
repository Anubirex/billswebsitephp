<footer class="site-footer">
        <div class="footer-container width-limiter">
            ...
            <div class="footer-contact">
                ...
                <hr class="hr-style-1">
                <a href="mailto:info@callbills.com?subject=Inquiry-Fom-Website"><div><svg id="email-icon" class="email-icon-main" data-name="Email Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 113.71 131.12"><g>
