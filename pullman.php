...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/pullman.php">
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/pullman-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/pullman.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/pullman-summary-large-image.webp">
    ...
    <body>
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/pullman-header-800w.webp"
                srcset="images/pullman-header-450w.webp 450w, 
                        images/pullman-header-800w.webp 800w, 
                        images/pullman-header-2000w.webp 2000w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        2000px"
                alt="Background photo of Pullman, WA"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Pullman, WA, a vibrant city known for its educational institutions and rolling hills, experiences a climate that demands attention to heating and cooling needs. The winters in Pullman are often cold and snowy, requiring robust heating systems to ensure a warm and comfortable indoor environment. Summers, characterized by their mildness, can nonetheless have periods of warmth, making efficient air conditioning essential for maintaining comfortable living conditions during these times. This range of weather conditions not only adds to Pullman's appeal as a center of learning and culture but also highlights the need for versatile HVAC systems to ensure comfort throughout the year.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Pullman, Washington for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Pullman</h2>
                        <p>Bill's Heating & A/C is deeply committed to providing the Pullman community with exceptional HVAC services. Our team's understanding of Pullman&apos;s specific climate allows us to offer tailored heating and cooling solutions. We ensure a strong presence in Pullman, with experienced technicians available to provide timely and efficient service. Our dedication to Pullman is more than just about service provision; it's about enhancing the comfort and satisfaction of each household and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Pullman, Washington." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Pullman, WA that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
