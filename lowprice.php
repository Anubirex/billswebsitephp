...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/privacy-policy.php">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NZQJPVRS"
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <div class="privacy-policy-main-background">
    <div class="privacy-policy-container width-limiter">
      <h1>Everyday Lowest Price Guarantee</h1>
      <p>
        We commit that we will offer the lowest price on the purchase and installation of new, qualifying equipment. If you receive a qualifying lower estimate, we&apos;ll not only match it &dash; we&apos;ll beat it! Exclusions apply.</p>
          <h2>How the Lowest Price Guarantee Works&colon;</h2>
          <p>Our commitment is to provide you with the lowest prices on the best equipment for your residence. We honor this commitment 365 days per year. 
          <br><br>
          If you receive an estimate for the purchase and installation of comparable qualifying equipment, we&apos;ll provide you with a lower estimate for the purchase and installation of like&dash;for&dash;like or comparable equipment. 
          <br><br>
          To qualify, you must provide us with a written estimate from a competitor that is less than 30 days old. Any competing estimates that you would like us to beat must be provided before the equipment is purchased and installed. In return, we will provide you with a lower estimate for the purchase and installation of equipment with similar or better specifications to meet the needs of your residence.
        </p>
          <h2>  Lowest Price Guarantee Exclusions&colon;</h2>
            <ul>
              <li>Installation of new construction/whole home ducted systems</li>
              <li>Commercial and special&dash;order products</li>
              <li>Discontinued, used, refurbished equipment.</li>
              <li>Estimates for undersized or equipment that is not suitable for the intended use</li>
              <li>Estimates for outdated equipment</li>
              <li>Volume or wholesale discount pricing offered by competitors</li>
              <li>Pricing from membership&dash;based wholesalers</li>
              <li>Pricing from auction websites</li>
              <li>Sales tax and permit fees</li>
              <li>Credit terms and finance offers</li>
            </ul>
    </div></div>
