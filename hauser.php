...
<html lang="en">
  <head>
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/hauser-summary-large-image.webp">
    ...
    <body>
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/hauser-header-800w.webp"
                srcset="images/hauser-header-450w.webp 450w, 
                        images/hauser-header-800w.webp 800w, 
                        images/hauser-header-1000w.webp 1000w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        1000px"
                alt="Background photo of Hauser, Idaho"
              ...
              <div class="areas-hero-container width-limiter">
                ...
                <div class="responsive-video">
                  <div class="video-wrapper" onclick="loadVideo(this, 'https://www.youtube.com/embed/m4KVBKSQ_sg?si=sQtXIuq-TdrQXwxC')">
                      <img class="area-video-placeholder" src="images/placeholder.webp" alt="Video Thumbnail" width="667" height="403">
                  </div>
                </div>
                </div>
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Hauser, ID, a charming and serene town, experiences a climate that brings its own set of heating and cooling challenges. The winters in Hauser are typically cold, often accompanied by snow, necessitating a reliable and efficient heating system to ensure a warm and comfortable indoor setting. Summers, while not overly hot, do require effective cooling solutions to maintain a pleasant indoor environment during the warmer days. This variation in seasonal weather not only adds to the quaint appeal of Hauser but also highlights the importance of versatile HVAC systems to provide consistent comfort throughout the year.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Hauser, Idaho for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Hauser</h2>
                        <p>In Hauser, Bill's Heating & A/C is dedicated to delivering exceptional HVAC services, tailored to the unique climate of the town. Our team has an in-depth understanding of Hauser's specific weather conditions, allowing us to offer heating and cooling solutions that are perfectly suited to local needs. We ensure a robust presence in Hauser, with skilled technicians always available to provide prompt and effective service. Our commitment to Hauser goes beyond just meeting service needs; we aim to enhance the comfort and quality of life for each home and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Hauser, Idaho." onclick="changeImage(this)" width="800" height="600">
