...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/sandpoint.php">
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/sandpoint-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/sandpoint.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/sandpoint-summary-large-image.webp">
    ...
    <body>
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/sandpoint-header-800w.webp"
                srcset="images/sandpoint-header-450w.webp 450w, 
                        images/sandpoint-header-800w.webp 800w, 
                        images/sandpoint-header-1200w.webp 1200w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        1200px"
                alt="Background photo of Sandpoint, Idaho"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Sandpoint, ID, renowned for its stunning natural beauty and vibrant community, experiences a climate that demands attention to both heating and cooling needs. The winters in Sandpoint are notably chilly and often snowy, calling for dependable and efficient heating systems to create a warm and inviting indoor atmosphere. The summers, while generally pleasant, can bring warm spells that necessitate reliable air conditioning for comfort. This range of weather conditions in Sandpoint not only contributes to its scenic allure but also highlights the importance of having versatile HVAC systems to ensure comfort throughout the ever-changing seasons.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Sandpoint, Idaho for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Sandpoint</h2>
                        <p>In Sandpoint, Bill's Heating & A/C is synonymous with trust and excellence in HVAC services. Our team, intimately familiar with Sandpoint's diverse climate, provides custom heating and cooling solutions to meet the specific needs of the community. We maintain a consistent presence in Sandpoint, with expert technicians readily available to ensure that your HVAC systems are functioning at their best. Our commitment to Sandpoint extends beyond mere service; we are devoted to ensuring the year-round comfort and well-being of every household and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Sandpoint, Idaho." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Sandpoint, ID that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
