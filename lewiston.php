...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/lewiston.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/lewiston-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/lewiston.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/lewiston-summary-large-image.webp">
    ...
    <script type="application/ld+json">
      ...
      "review": [
      {
        ...
        "reviewBody": "Bill's Heating and Cooling is amazing! With the gas outage they went above and beyond not only once, but three times, to bring heat back to our home. A special shout out to Matthew Smith who came right over at 630pm on his day off! If anyone in Lewiston is in need of service, I would highly recommend him as your man to get the job done!",
        "publisher": {
          "@type": "Organization",
          "name": "Google Reviews"
        }
  ...
  <!-- End Google Tag Manager (noscript) -->
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/lewiston-header-800w.webp"
                srcset="images/lewiston-header-450w.webp 450w, 
                        images/lewiston-header-800w.webp 800w, 
                        images/lewiston-header-1024w.webp 1024w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        1024px"
                alt="Background photo of Lewiston, Idaho"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Lewiston, ID, a city with a rich history and a dynamic community, experiences a climate that requires special attention to heating and cooling needs. Known for its milder winters compared to other parts of Idaho, Lewiston still experiences chilly periods that necessitate effective heating systems. Summers can be quite warm, often calling for reliable air conditioning to ensure indoor comfort during these hotter months. This range of weather conditions in Lewiston not only contributes to its unique character but also emphasizes the importance of having versatile and efficient HVAC systems to ensure comfort for its residents throughout the year.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Lewiston, Idaho for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Lewiston</h2>
                        <p>Bill's Heating & A/C has a strong commitment to the Lewiston community, offering top-notch HVAC services designed to meet the city's specific climate needs. Our team, with a deep understanding of Lewiston's weather patterns, provides customized heating and cooling solutions for both homes and businesses. Our second Location and many of our technicians are regularly present in Lewiston, ensuring timely and efficient service to keep your HVAC systems in excellent condition. Our dedication to Lewiston extends beyond service; we are devoted to enhancing the comfort and satisfaction of every client we serve.</p>
                    </div>
                </div>
          </section>
                    ...
                    <div class="carousel-slide">
                      <div class="review-card">
                        <div class="review-card-top">
                          ...
                          <h3>R</h3>
                          <div class="review-name-title">
                            <span class="reviewer-name">Crystal Hawkins</span>
                            <span class="review-source">Google Review</span></div></div>
                            <div class="review-card-stars">
                              <p class="star-emojies">&#x2B50;&#x2B50;&#x2B50;&#x2B50;&#x2B50;</p></div>
                        </div>
                        <div class="review-content">
                          <p>Bill&apos;s Heating and Cooling is amazing! With the gas outage they went above and beyond not only once, but three times, to bring heat back to our home. A special shout out to Matthew Smith who came right over at 630pm on his day off! If anyone in Lewiston is in need of service, I would highly recommend him as your man to get the job done!</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-slide">
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Lewiston, Idaho." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Lewiston, ID that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
