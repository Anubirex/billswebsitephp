...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/areas.php">
    ...
    <link rel="stylesheet" href="styles/areascritical.css">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:url" content="https://callbillsheating.com/areas.php">
    ...
    <script type="application/ld+json">
      {
        ...
        "areaServed": ["Post Falls, ID", "Coeur d'Alene, ID", "Spokane, WA"],
    ...
    <?php include 'header.php'; ?>
      <section class="service-areas-hero">
        <img class="hero-image" src="images/areas-header-800w.webp"
                srcset="images/areas-header-450w.webp 450w, 
                        images/areas-header-800w.webp 800w, 
                        images/areas-header-2000w.webp  2000w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        2000px"
                alt="Background photo of a mountain in the pacific northwest."
                width="800" height="496"
                aria-hidden="true">
        <div class="service-areas-hero-container width-limiter">
        <div class="service-areas-title width-limiter">
          <h1>Service Areas</h1></div>
        <div class="states">
        <svg xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" class="us-map" preserveAspectRatio="xMinYMin meet"  inkscape:version="0.91 r13725" x="0px" y="0px" width="384px" height="222px" viewBox="174 100 384 222" enable-background="new 174 100 384 222" xml:space="preserve">
            <g id="g5">
            <path class="MT"  fill="#2c2c2c" d="M530.7,222.3l0.6-11.2l2.3-24.8c0.5-5,1.1-8.5,1.4-15.4l0.9-14.6l-30.7-2.8L476,150l-29.3-4   l-32.3-5.3l-18.4-3.4l-32.7-6.9l-4.5,21.3l3.4,7.5l-1.4,4.6l1.8,4.6l3.2,1.4l4.6,10.8l2.7,3.2l0.5,1.1l3.4,1.1l0.5,2.1l-7.1,17.6   v2.5l2.5,3.2h0.9l4.8-3l0.7-1.1l1.6,0.7l-0.2,5.3l2.7,12.6l3,2.5l0.9,0.7l1.8,2.3l-0.5,3.4l0.7,3.4l1.1,0.9l2.3-2.3h2.7l3.2,1.6   l2.5-0.9h4.1l3.7,1.6l2.7-0.5l0.5-3l3-0.7l1.4,1.4l0.5,3.2l1.8,1.4l1.5-11.6l20.7,3l28.2,4l16.6,1.9l31.4,3.5l11,1.5l1.1-15.4   L530.7,222.3z"/>
            <a href="#Idahoserviceareas" aria-label="Go to Idaho Service Areas"><path class="ID"  fill="#2c8ddb" d="M336.1,281c-22.6-4.3-14.1-2.8-21.1-4.4l4.4-17.5l4.3-17.7l1.4-4.2l2.5-5.9l-1.3-2.3l-2.5,0.1   l-0.8-1l0.5-1.1l0.3-3.1l4.5-5.5l1.8-0.5l1.1-1.1l0.6-3.2l0.9-0.7l3.9-5.8l3.9-4.3l0.2-3.8l-3.4-2.6l-1.3-4.4l0.4-9.7l3.7-16.5   l4.5-20.8l3.8-13.5l0.8-3.8l13,2.5l-4.2,21.5l2.9,7.7l-1.1,4.6l2,4.6l3.2,1.7l4.5,9.8l2.7,3.8l0.6,1.1l3.4,1.1l0.5,2.5l-6.9,16.8   l0.3,3.3l2.7,2.9l1.9,0.5l4.8-3.6l0.4-0.5l0.2,0.8l0.3,4.1l2.6,12.9l3.5,2.7l0.4,0.8l2.1,2.4l-0.8,2.8l0.7,3.8l1.9,0.9l2.1-1.6   l2.6-0.5l3.4,1.6l2.5-0.6l3.8-0.2l4,1.6l2.7-0.3l0.9-2.3l2.5-1.6l0.7,1.7l0.6,2.2l2.3,2.5l-3.8,24l-5.1,29l-4.2-0.3l-8.2-1.5   l-9.8-1.8l-12.2-2.4l-12.5-2.5l-8.5-1.8l-9.3-1.7L336.1,281z"/>
          </a><a href="#Washingtonserviceareas" aria-label="Go to Washington Service Areas"><path class="WA"  fill="#2c8ddb" d="M267.6,106.4l4.4,1.5l9.7,2.7l8.6,1.9l20,5.7l23,5.7l15.2,3.4l-1,3.9l-4.1,13.8l-4.5,20.8   l-3.2,16.1l-0.4,9.4l-13.2-3.9l-15.6-3.4l-13.7,0.6l-1.6-1.5l-5.3,1.9l-4-0.3l-2.7-1.8l-1.6,0.5l-4.2-0.2l-1.9-1.4l-4.8-1.7   l-1.4-0.2l-5-1.3l-1.8,1.5l-5.7-0.3l-4.8-3.8l0.2-0.8l0.1-7.9l-2.1-3.9l-4.1-0.7l-0.4-2.4l-2.5-0.6l-2.9-0.5l-1.8,1l-2.3-2.9   l0.3-2.9l2.7-0.3l1.6-4l-2.6-1.1l0.2-3.7l4.4-0.6l-2.7-2.7l-1.5-7.1l0.6-2.9v-7.9l-1.8-3.2l2.3-9.4l2.1,0.5l2.4,2.9l2.7,2.6   l3.2,1.9l4.5,2.1l3.1,0.6l2.9,1.5l3.4,1l2.3-0.2v-2.4l1.3-1.1l2.1-1.3l0.3,1.1l0.3,1.8l-2.3,0.5l-0.3,2.1l1.8,1.5l1.1,2.4l0.6,1.9   l1.5-0.2l0.2-1.3l-1-1.3l-0.5-3.2l0.8-1.8l-0.6-1.5V119l1.8-3.6l-1.1-2.6l-2.4-4.8l0.3-0.8L267.6,106.4z M258.1,112.3l2-0.2   l0.5,1.4l1.5-1.6h2.3l0.8,1.5l-1.5,1.7l0.6,0.8l-0.7,2l-1.4,0.4c0,0-0.9,0.1-0.9-0.2s1.5-2.6,1.5-2.6l-1.7-0.6l-0.3,1.5l-0.7,0.6   l-1.5-2.3L258.1,112.3z"/>
            </a><path class="OR"  fill="#2c2c2c" d="M314.3,276.7l4.3-17.9l4.7-17.9l1.1-4.2l2.4-5.6l-0.6-1.2l-2.5,0l-1.3-1.7l0.5-1.5l0.5-3.2l4.5-5.5   l1.8-1.1l1.1-1.1l1.5-3.6l4-5.7l3.6-3.9l0.2-3.5l-3.3-2.5l-1.2-4.5l-13.2-3.7l-15.1-3.5l-15.4,0.1l-0.5-1.4l-5.5,2.1l-4.5-0.6   l-2.4-1.6l-1.3,0.7L273,184l-1.7-1.4l-5.3-2.1l-0.8,0.1l-4.3-1.5l-1.9,1.8l-6.2-0.3l-5.9-4.1l0.7-0.8l0.2-7.8l-2.3-3.9l-4.1-0.6   l-0.7-2.5l-2.4-0.5l-5.8,2.1l-2.3,6.5l-3.2,10l-3.2,6.5l-5,14.1l-6.5,13.6l-8.1,12.6l-1.9,2.9l-0.8,8.6l-1.3,6l2.7,3.5l6.7,2.3   l11.6,3.3l7.9,2.5l12.4,3.6l13.3,3.6l13.2,3.6Z"/>
            </g>
        </svg> </div></div>
        <p>&dash;Choose Your State To See Our Service Areas&dash;</p>
    </section>
      <section class="why-us">
        <h2 class="why-us-title">WHY CHOOSE US?</h2>
        <div class="why-us-under-title">
        <div class="why-us-imgs width-limiter">
          <div  class="choose-us-card" data-animation="grow-and-shrink"><a href="lowprice.php">
            ...
            <div class="choose-us-card-bottom">
              <p>Bill&apos;s Heating and AC will beat or match any competitors pricing! 
                 Click here for more info about our everyday low price guarantee!
              </p>
            </div></a>
          </div>
          ...
          <div class="choose-us-card" data-animation="grow-and-shrink"><a href="freesecop.php">
            ...
            <div class="choose-us-card-bottom">
              <p>If you dont agree with another contractors assesment, diagnosis, or pricing, call us for a FREE second opinion!
              </p>
            </div></a>
          </div>
        </div></div>
      ...
      <section class="our-locations-section">
        <div class="our-locations-section-whitespace-outer width-limiter">
        <div class="our-locations-section-inner">
        <div class="our-locations-title">
          <h2>Our Locations</h2>
        </div>
        <div class="our-locations">
          <h3 id="zoomtopostfalls">Post Falls</h3>
          <div class="our-locations-img">
            <img loading="lazy" data-animation="zoom-in-up" src="images/pf-header-450w.webp" alt="HVAC services near me in Post Falls" width="450" height="300">
          </div>
          <p>Welcome to Bill&apos;s Heating & A/C&apos;s Post Falls location, your premier HVAC solutions provider, strategically located in Post Falls, Idaho. We are proud to offer top-notch heating, ventilation, and air conditioning services to the entire North Idaho region and Eastern Washington. Our expertise in HVAC systems, coupled with our commitment to quality and customer satisfaction, makes us the go-to choice for all your heating and cooling needs.
        ...
        <div class="our-locations">
          ...
          <div class="our-locations-img">
            <img loading="lazy" data-animation="zoom-in-up" src="images/lewiston-header-450w.webp" alt="HVAC services near me in Lewiston" width="450" height="300">
          </div>
          <p>Discover unparalleled HVAC services at Bill&apos;s Heating & A/C&apos;s Lewiston location, conveniently situated in the heart of Lewiston, Idaho. Our commitment to excellence in heating, ventilation, and air conditioning services extends throughout the Lewiston area and its neighboring communities. Renowned for our expertise and dedication to customer satisfaction, we are your ideal partner for maintaining comfortable indoor environments.
            In need of &apos;HVAC services near me&apos; in Lewiston? Look no further! Our skilled team of certified technicians is equipped to handle all your HVAC needs, whether it&apos;s for your home or business. We offer comprehensive services including installation, repair, and maintenance, ensuring that your heating and cooling systems are operating at peak efficiency.
            At Bill&apos;s Heating & A/C, we understand Lewiston&apos;s unique climate and are adept at providing HVAC solutions that are perfectly suited to the local weather conditions. Our proximity and knowledge of the area mean we can offer personalized and efficient services to our clients.
            Choose us for a seamless and customer-focused HVAC experience. We are ready to assist you with all your heating and cooling requirements in Lewiston and its surrounding areas. Depend on Bill&apos;s Heating & A/C for prompt, reliable, and top-quality HVAC services, right in your local area.</p>
          </div></div></div>
      </section>
      <section class="reviews-section">
        <div class="reviews-container width-limiter">
          ...
          <div class="carrousel-container">      
            ...
            <div class="leave-a-review" id="Idahoserviceareas">
      ...
      <section class="service-areas-locations">
        <div class="serv-areas-loc-main-title width-limiter">
          ...
          <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
            ...
            <div class="thumbnail-container">
                ...
                <div class="areas-gallery-imgs">
                    <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC." onclick="changeImage(this)" width="800" height="600">
                    ...
                    <img loading="lazy" src="images/ac-two.webp" class="thumbnail" alt="An air conditioning condenser professionally installed. It is in a green yard by a white fence." onclick="changeImage(this)" width="800" height="600">
                    ...
                    <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                </div>
