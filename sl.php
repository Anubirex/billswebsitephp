...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/sl.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/sl-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/sl.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/sl-summary-large-image.webp">
  ...
  <!-- End Google Tag Manager (noscript) -->
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/sl-header-800w.webp"
                srcset="images/sl-header-450w.webp 450w, 
                        images/sl-header-800w.webp 800w, 
                        images/sl-header-1344w.webp 1344w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        1344px"
                alt="Background photo of Spirit Lake, Idaho"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Spirit Lake, ID, a town renowned for its tranquil beauty and strong community spirit, experiences a climate that calls for thoughtful heating and cooling solutions. The winters in Spirit Lake can be quite chilly, often bringing in a blanket of snow, necessitating robust heating systems for a comfortable indoor living environment. The summers, though generally mild, can have periods of warmth, making efficient air conditioning important for maintaining indoor comfort. The varied climate of Spirit Lake not only adds to its natural charm but also underscores the need for reliable and effective HVAC systems to ensure comfort throughout the diverse seasons.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Spirit Lake, Idaho for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Spirit Lake</h2>
                        <p>At Bill's Heating & A/C, we are deeply rooted in the Spirit Lake community, offering unmatched HVAC services tailored to the local climate. Our team is well-acquainted with the specific weather patterns of Spirit Lake, enabling us to provide custom heating and cooling solutions. With technicians consistently available in the area, we ensure swift and efficient service, keeping your HVAC systems in peak condition. Our commitment to Spirit Lake is not just about providing services; it's about ensuring the comfort and well-being of every resident and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Spirit Lake, Idaho." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Spirit Lake, ID that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
