...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/chattaroy-summary-large-image.webp">
  ...
  <!-- End Google Tag Manager (noscript) -->
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/chattaroy-header-800w.webp"
                srcset="images/chattaroy-header-450w.webp 450w, 
                        images/chattaroy-header-800w.webp 800w, 
                        images/chattaroy-header-1920w.webp 1920w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        1920px"
                alt="Background photo of Chattaroy, WA"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Chattaroy, WA, a community known for its scenic landscapes and tranquil rural setting, experiences a climate that necessitates reliable heating and cooling systems. The winters in Chattaroy are often cold, requiring robust heating solutions to ensure a warm and comfortable indoor atmosphere. Summers, while generally mild, can see warmer periods, highlighting the need for efficient air conditioning to maintain pleasant living conditions during these warmer months. This variation in weather conditions not only adds to Chattaroy’s pastoral charm but also emphasizes the importance of versatile HVAC systems to provide year-round comfort for its residents.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Chattaroy, Washington for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Chattaroy</h2>
                        <p>Bill's Heating & A/C is dedicated to providing the Chattaroy community with exceptional HVAC services. Our understanding of Chattaroy’s specific climate allows us to offer tailored heating and cooling solutions. We maintain a strong presence in Chattaroy, with skilled technicians ready to provide prompt and efficient service. Our commitment to Chattaroy is more than just about providing services; it’s about enhancing the comfort and well-being of every home and business in the area.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Chattaroy, Washington." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Chattaroy, WA that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
