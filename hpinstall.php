...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbills.com/hpinstall.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:url" content="https://callbills.com/hpinstall.php">
          ...
          <section class="areas-local-needs furn-inst-expect-section">
            <div class="local-needs-container width-limiter">
                ...
                <div class="local-needs-img" data-animation="zoom-in-right">
                    <img class="twobyone-image" src="blogimages/shaking-hands.webp" alt="A Bill's Heating heat pump expert technician is shaking hand with a woman at the front door to her home." loading="lazy" width="600" height="300">
                </div>
            </div>
            </section>
