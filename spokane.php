...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/spokane.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/spokane-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/spokane.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/spokane-summary-large-image.webp">
    ...
    <script type="application/ld+json">
      ...
      "review": [
        ...
        },
        {
          ...
          "reviewBody": "Dustin recently just repaired our fireplace. He was quite a nice young man and knew what he was talking about. We much appreciated his knowledge and friendliness, janis and Bruce nelson spokane wa",
          "publisher": {
            "@type": "Organization",
            "name": "Google Reviews"
          }
  ...
  <!-- End Google Tag Manager (noscript) -->
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/spokane-header-800w.webp"
                srcset="images/spokane-header-450w.webp 450w, 
                        images/spokane-header-800w.webp 800w, 
                        images/spokane-header-2000w.webp 2000w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        2000px"
                alt="Background photo of Spokane, WA"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Spokane, WA, a bustling city with a charm of its own, experiences a full range of seasons, each bringing distinct heating and cooling challenges. The winters here can be quite cold, with snowfall that transforms the city into a picturesque winter wonderland, necessitating reliable heating systems. Summers, on the other hand, are warm and sunny, often requiring efficient cooling solutions to maintain comfort. The varying climate of Spokane not only showcases the city's diverse natural beauty but also underscores the importance of a dependable HVAC system to ensure a comfortable living and working environment throughout the year.</p>
                </div>
                <div class="local-needs-img" data-animation="zoom-in-right">
                    <img loading="lazy" class="twobyone-image" src="images/hot-cold-landscape.webp" alt="A photo of a Washington landscape. The left half is summer. The right half is winter." width="600" height="300">
                </div>
            </div>
            </section>
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in SPokane, Washington for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Spokane</h2>
                        <p>In the heart of Spokane, Bill's Heating & A/C stands as a beacon of expertise and reliability for all your HVAC needs. Our team is well-acquainted with Spokane's unique climate patterns, allowing us to offer tailored solutions for your home or business. We have a strong presence in the city, with skilled technicians regularly available to ensure your heating and cooling systems are functioning at their best. Our commitment to the community goes beyond just providing services; we aim to be a partner in maintaining the comfort and quality of your indoor environment.</p>
                    </div>
                </div>
          </section>
                    ...
                    <div class="carousel-slide">
                      <div class="review-card">
                        <div class="review-card-top">
                          ...
                          <h3>R</h3>
                          <div class="review-name-title">
                            <span class="reviewer-name">Janice Nelson</span>
                            <span class="review-source">Google Review</span></div></div>
                            <div class="review-card-stars">
                              <p class="star-emojies">&#x2B50;&#x2B50;&#x2B50;&#x2B50;&#x2B50;</p></div>
                        </div>
                        <div class="review-content">
                          <p>Dustin recently just repaired our fireplace. He was quite a nice young man and knew what he was talking about. We much appreciated his knowledge and friendliness, janis and Bruce nelson spokane wa</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-slide">
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Spokane, WA." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Spokane, Washington that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
