...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/troy.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/troy-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/troy.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/troy-summary-large-image.webp">
  ...
  <!-- End Google Tag Manager (noscript) -->
        ...
        <div class="modal">
          ...
          <section class="areas-hero">
            <img class="hero-image" src="images/troy-header-800w.webp"
                srcset="images/troy-header-450w.webp 450w, 
                        images/troy-header-800w.webp 800w, 
                        images/troy-header-2000w.webp 2000w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        2000px"
                alt="Background photo of Troy, Idaho"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Troy, ID, a town with a rich heritage and a strong sense of community, experiences a climate that underscores the importance of effective heating and cooling systems. The winters in Troy are known for their cool temperatures, necessitating reliable heating systems to ensure a cozy indoor setting during the colder months. Summers, while generally mild, can see warmer spells that make efficient air conditioning important for maintaining comfortable living conditions. This variation in seasonal weather not only contributes to Troy’s charm but also emphasizes the need for versatile HVAC systems to provide consistent comfort throughout the year.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Troy, Idaho for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Troy</h2>
                        <p>Bill's Heating & A/C is committed to providing Troy with exceptional HVAC services, customized to meet the town&apos;s specific climate needs. Our team is well-acquainted with Troy&apos;s weather patterns, enabling us to offer tailored heating and cooling solutions. We ensure a steady presence in Troy, with skilled technicians available to provide timely and effective service. Our dedication to Troy goes beyond just service provision; we focus on enhancing the comfort and well-being of each household and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Troy, Idaho." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Troy, ID that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
