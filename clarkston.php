...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/clarkston.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/clarkston-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/clarkston.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/clarkston-summary-large-image.webp">
  ...
  <!-- End Google Tag Manager (noscript) -->
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/clarkston-header-800w.webp"
                srcset="images/clarkston-header-450w.webp 450w, 
                        images/clarkston-header-800w.webp 800w, 
                        images/clarkston-header-2000w.webp 2000w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        2000px"
                alt="Background photo of Clarkston, WA"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Clarkston, WA, a city known for its scenic river views and vibrant community, experiences a climate that underscores the importance of reliable heating and cooling systems. The winters in Clarkston are typically chilly, often requiring a dependable heating system to ensure a warm and comfortable indoor atmosphere. Summers, while mild, can have warmer periods, making effective air conditioning important for maintaining comfortable living conditions during these times. This variation in weather conditions not only adds to Clarkston’s charm but also highlights the need for versatile HVAC systems to provide consistent comfort throughout the year.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Clarkston, Washington for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Clarkston</h2>
                        <p>Bill's Heating & A/C is committed to serving the Clarkston community with top-notch HVAC services. Our expertise in the local climate enables us to offer customized heating and cooling solutions that perfectly fit the community's needs. We maintain a strong presence in Clarkston, with skilled technicians available to provide prompt and efficient service. Our dedication to Clarkston goes beyond just providing services; it's about enhancing the comfort and well-being of each home and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Clarkston, Washington." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Clarkston, WA that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
