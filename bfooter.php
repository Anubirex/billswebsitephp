...
<footer class="site-footer">
        <div class="footer-container width-limiter">
            ...
            <div class="footer-contact">
                ...
                <svg id="location-icon1" class="footer-location-icon icon-common-elements" data-name="location-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 91.42 114.37"><g>
                    ...
                    <address>
                    3920 E Lanark St, Suite 100<br>
                    Meridian, ID 83642<br>
                    </address></div></a>
                <hr class="hr-style-1">
                <a href="tel:+12089624557"><div><svg    version="1.1" id="phone-icon" class="phone-icon-main" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
        ...
        <div class="footer-bottom">
            <p>&lt;&lt;&lt; &copy; 2023 Bill&apos;s Heating and A/C. All rights reserved.  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $base_url; ?>privacy-policy.php">PRIVACY POLICY</a>&nbsp; &gt;&gt;&gt; </p>
        </div>
        <!--      //////////////////////////////SOCIAL SIDEBAR/////////////////////////////////////////////// -->
        <div class="social-sidebar desktop-only">
          <a href="https://www.facebook.com/billsheatingboise" aria-label="Visit Bill's Heating and AC on Facebook" target="_blank" rel="noopener noreferrer"></a>
