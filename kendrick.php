...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/kendrick.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/kendrick-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/kendrick.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/kendrick-summary-large-image.webp">
  ...
  <!-- End Google Tag Manager (noscript) -->
        ...
        <div class="modal">
          ...
          <section class="areas-hero">
            <img class="hero-image" src="images/kendrick-header-800w.webp"
                srcset="images/kendrick-header-450w.webp 450w, 
                        images/kendrick-header-800w.webp 800w, 
                        images/kendrick-header-940w.webp 940w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        940px"
                alt="Background photo of Kendrick, Idaho"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Kendrick, ID, a quaint town nestled amidst rolling hills and lush landscapes, experiences a climate that necessitates efficient heating and cooling systems. The winters in Kendrick can be quite chilly, often calling for a reliable heating solution to maintain a warm and comfortable indoor environment. Summers, while typically moderate, can have periods of warmth, underscoring the importance of effective air conditioning for maintaining a pleasant living space during these times. This variation in weather throughout the year not only adds to Kendrick’s rural beauty but also highlights the need for versatile HVAC systems to ensure year-round comfort for its residents.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Kendrick, Idaho for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Kendrick</h2>
                        <p>Bill's Heating & A/C is deeply dedicated to serving the Kendrick community with outstanding HVAC services. Our understanding of Kendrick's unique climate challenges enables us to offer customized heating and cooling solutions. We maintain a strong presence in Kendrick, with experienced technicians readily available to provide prompt and efficient service. Our commitment to Kendrick goes beyond just fulfilling service needs; it’s about enhancing the comfort and quality of life for every home and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Kendrick, Idaho." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Kendrick, ID that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
