...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://callbillsheating.com/genesee.php">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <!-- End Google Tag Manager -->
    ...
    <meta property="og:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/genesee-social-share.webp">
    <meta property="og:url" content="https://callbillsheating.com/genesee.php">
    ...
    <meta name="twitter:image" content="https://callbillsheating.s3.us-west-2.amazonaws.com/genesee-summary-large-image.webp">
  ...
  <!-- End Google Tag Manager (noscript) -->
        <?php include 'header.php'; ?>
          <section class="areas-hero">
            <img class="hero-image" src="images/genesee-header-800w.webp"
                srcset="images/genesee-header-450w.webp 450w, 
                        images/genesee-header-800w.webp 800w, 
                        images/genesee-header-2000w.webp 2000w"
                sizes="(max-width: 450px) 450px, 
                       (max-width: 799px) 800px, 
                        2000px"
                alt="Background photo of Genesee, Idaho"
          ...
          <section class="areas-local-needs">
            <div class="local-needs-container width-limiter">
                <div class="local-needs-text">
                    ...
                    <p>Genesee, ID, a town known for its agricultural heritage and close-knit community, experiences a climate that emphasizes the need for reliable heating and cooling systems. Winters in Genesee can be brisk, often requiring a robust heating system to ensure a warm and inviting indoor atmosphere during the colder months. Summers, while generally pleasant, can bring warmer periods, making efficient air conditioning essential for maintaining comfortable living conditions. This range of weather conditions not only adds to Genesee’s rural charm but also highlights the importance of having adaptable HVAC systems to provide comfort throughout the diverse seasons.</p>
                </div>
            ...
            <section class="areas-commitment">
                <div class="areas-commitment-container width-limiter">
                    <div class="areas-commitment-img" data-animation="zoom-in-left">
                        <img loading="lazy" class="twobyone-image" src="images/techs-arriving.webp" alt="Two HVAC technicians arriving at a customers home in Genesee, Idaho for a service call." width="600" height="300">
                    </div>
                    <div class="areas-commitment-text">
                        <h2>Our Commitment to Genesee</h2>
                        <p>Bill's Heating & A/C is committed to providing the Genesee community with top-tier HVAC services, tailored to meet the town’s unique climate needs. Our team, familiar with Genesee’s specific weather patterns, offers customized heating and cooling solutions. We ensure a consistent presence in Genesee, with skilled technicians available to provide prompt and effective service. Our dedication to Genesee is more than just about service; it’s about enhancing the comfort and well-being of every household and business we serve.</p>
                    </div>
                </div>
          </section>
              ...
              <p>At Bill's Heating and A/C, our commitment to quality shines through in every project. 
                ...
                <div class="thumbnail-container">
                    ...
                    <div class="areas-gallery-imgs">
                      <img loading="lazy" src="images/furnace-one.webp" class="thumbnail active" alt="A high efficiency York furnace installed by Bills Heating and AC in Genesee, Idaho." onclick="changeImage(this)" width="800" height="600">
                      ...
                      <img loading="lazy" src="images/ac-three.webp" class="thumbnail" alt="A freshly installed York air conditioner in Genesee, ID that will make the customer's home cooler and more comfortable." onclick="changeImage(this)" width="800" height="600">
                  </div>
