...
<main class="product-detail">
    <section class="product-overview">
        ...
        <div class="product-summary">
            ...
            <div class="product-meters">
                <div class="meter">
                    <label for="efficiency-meter">Efficiency (AFUE): 96%</label>
                    <div class="meter-bar">
                        <div id="efficiency-meter" class="meter-fill" style="width: 96%;"></div>
                    </div>
                </div>
                <div class="meter">
    ...
    <section class="product-description">
        ...
        <p>The YORK® Y91E Compact Gas Furnace is engineered to provide exceptional comfort and efficiency for your home. With an impressive 96% AFUE rating, this furnace ensures that you get maximum warmth from the fuel you pay for, significantly reducing your energy costs. Its compact 33-inch height allows for installation in tight spaces, making it a versatile choice for various home configurations.</p>
