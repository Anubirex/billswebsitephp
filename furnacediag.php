  ...
  <div class="modal">
    ...
    <div class="diag-page-section-two">
        <div class="diag-page-inner-section-two width-limiter">
            <h3>Unmatched Expertise in Furnace Diagnostics</h3>
            <p>Our team of experienced professionals is the cornerstone of our diagnostic services. We bring extensive knowledge and skills to each appointment, ensuring a comprehensive examination of your furnace. We utilize advanced diagnostic tools to accurately pinpoint issues, offering transparent communication throughout the process. Our commitment to quality service and customer satisfaction is evident in every diagnostic check we perform.</p>
        </div>
    </div>
    ...
    <div class="diag-page-section-three">
        <div class="diag-page-inner-section-three width-limiter">
            ...
            <p>Our diagnostic process begins with a thorough visual inspection to identify any apparent problems. We then delve deeper, using sophisticated diagnostic equipment to uncover hidden issues. Upon completion of the diagnostics, we provide a detailed report of our findings, ensuring you have a clear understanding of the health and status of your furnace. Based on our analysis, we offer personalized recommendations tailored to address the specific needs of your system, whether that involves repairs, maintenance, or potential upgrades.</p>
        </div>
    </div>
    
    <div class="diag-page-section-four">
        <div class="diag-page-inner-section-four width-limiter">
            <h3>Addressing a Wide Range of Furnace Problems</h3>
            <p>Our diagnostic services are designed to identify and address various common furnace issues, including inefficient heating, unusual noises or odors, frequent cycling, ignition or pilot light problems, and thermostat malfunctions. We approach each situation with the expertise and attention to detail necessary to ensure your furnace operates smoothly and efficiently.</p>
        </div>
    </div>
    <div class="red-divider"></div>
    ...
    <section class="furn-inst-why-us">
      ...
      <div class="furn-inst-why-list width-limiter">
        <ul>
          <li><span>Rapid and Reliable Service</span> &dash; We pride ourselves on offering prompt diagnostic services to swiftly address your furnace issues.</li>
          ...
          <li><span>Same-Day Emergency Appointments</span> &dash; We understand the urgency of furnace problems and offer same-day services for emergency situations.</li>
          <li><span>Free Second Opinions</span> &dash; Don&rsquo;t agree with another contractor&rsquo;s assessment of pricing? Give us a call for a FREE second look!</li>
          ...
          <li><span>Comprehensive Furnace Solutions</span> &dash; From the initial diagnostic assessment to complete repairs and maintenance, we cover all aspects of furnace care.</li>
      </ul>  
      </div>
      </section>
      <section class="get-started-outer">
        <div class="get-started width-limiter">
            ...
            <div class="lets-get-started" data-animation="zoom-in-right">
                <h2>Schedule your Furnace Diagnostic Today!</h2>
                ...
                <p>Don&rsquo;t let furnace problems disrupt your comfort. Schedule a diagnostic appointment with Bill's Heating and AC today. Our team of experienced technicians will ensure that your furnace operates at its best, offering you peace of mind and a warm, comfortable home. Contact us now for exceptional furnace diagnostic services.</p>
            </div>
        </div>
    </section>
