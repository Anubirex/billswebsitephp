...
<header>
    <div class="message-banner">
      <div class="scroll-text">
       <h3>The area&apos;s largest and most trusted HVAC company - Serving Boise and the entire Treasure Valley</h3>
      </div>
    </div>   
    <div class="top-bar width-limiter">
        ...
        <a href="tel:+12089624557" class="phone-number desktop-only"> 208-96-BILLS</a>
